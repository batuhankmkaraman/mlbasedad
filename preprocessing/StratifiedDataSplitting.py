...
class StratifiedDataSplitting:
    def __init__(self, directory_to_read, directory_to_save):
        ...
        Returns:
            ...
            Saves the indices of train/val/test splits as splits/tvt_x_y.txt where x and y correspond to train/test and train/val split identifiers, respectively. Recall that we have 200 train/test splits, and for each split, 5 train/val splits in the paper. Therefore, x ranges from 0 to 199, and y ranges from 0 to 4.
        """
    ...
    def create_trainvaltest_splits(self):
        """
